...
function CoatsPage(props) {
    ...
    function displayInstance(data) {
        setDisplay(false);
        setProductInstance(<CoatInstance setProductInstance={setProductInstance} refresh={refresh} getModelsAndBrands={getModelsAndBrands} id={data.id} data={data.data} model={data.model} brandName={data.brandName} picture={data.picture} setMainPage={props.setMainPage}  setModels={setModels} brands={brands} models={models}/>);
    }
    ...
    return (
        <div className="productPage">
            ...
            <div className="modelsWrapper">
                <div className="intro">
                    {/* <button className='addSizeButton' onClick={()=>setAddModel(<CoatAdd setModels={setModels} refresh={refresh} models={models} getModelsAndBrands={getModelsAndBrands} brands={brands} setAddModel={setAddModel} />)}> {addIcon}<span>Add Coat Model</span> </button>   */}
                    <button className='addSizeButton' onClick={()=>setAddModel(<ProductAdd sendData={sendData} setModels={setModels} refresh={refresh} models={models} getModelsAndBrands={getModelsAndBrands} brands={brands} setAddModel={setAddModel} />)}> {addIcon}<span>Add Coat Model</span> </button>               
                </div>
