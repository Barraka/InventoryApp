...
function AccessoriesPage(props) {
    ...
    function displayInstance(data) {
        setDisplay(false);
        setProductInstance(<BrandInstance setProductInstance={setProductInstance} refresh={refresh} id={data._id} data={data} brandName={data.name} picture={data.picture} setMainPage={props.setMainPage} />);
    }
        ...
        <div className="productPage">
            ...
            <div className="modelsWrapper">
                ...
                <div className="models">
                    ...
                    {data ? data.map((x,i)=><ProductCard nosize={true} forBrands={true}  displayInstance={displayInstance} key={x._id || i} id={x._id} data={x} brandName={x.name} picture={x.picture || placeholderImage} setMainPage={props.setMainPage}/>): <div className='loadingWrapper'><img src={loading} alt="loading" /></div>}
