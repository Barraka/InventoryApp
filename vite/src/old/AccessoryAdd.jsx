...
function AccessoryAdd(props) {
    const [data, setData] = useState({model: '', brand: '', brandName: '', price: '', picture:placeholderImage, quantity:1});
    ...
    return (
        <div className="addProduct">
            ...
            <div className="addProductBody">
                <div className="addProductTitle">Add another product:</div>
